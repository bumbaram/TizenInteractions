#ifndef _TIZENSENDER_H_
#define _TIZENSENDER_H_
...
/**
 * [TizenSenderApp] UiApp must inherit from UiApp class
 * which provides basic features necessary to define an UiApp.
 */
class TizenSenderApp
